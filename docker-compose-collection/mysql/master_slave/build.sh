...
rm -rf ./master/docker_mysql_data/*
rm -rf ./slave/docker_mysql_data/*
...
priv_stmt='CREATE USER "test_slave_user"@"%" IDENTIFIED BY "test_slave_pwd"; GRANT REPLICATION SLAVE ON *.* TO "test_slave_user"@"%"; FLUSH PRIVILEGES;'
...
start_slave_stmt="CHANGE MASTER TO MASTER_HOST='mysql_master',MASTER_USER='test_slave_user',MASTER_PASSWORD='test_slave_pwd',MASTER_LOG_FILE='$CURRENT_LOG',MASTER_LOG_POS=$CURRENT_POS; START SLAVE;"
